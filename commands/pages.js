...
exports.run = (client, message, args, tools) =>{
  ...
  'Translation\n\nlang <the abbrevated version of the language you want to your default language to be.> - this sets up your personal translator. (just doing panda!lang will give you the list of the languages and their abbrevated forms.\n\ndisable - this will disable your personal translator\nenable - this will enable your personal translator.\n\ntranslate <language the message is in> <the language you want it to be in> <the message>: translate the message, it is usefully to use to communicate with people that don\'t speak your language',
